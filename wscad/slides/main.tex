...
\frame{\frametitle{Results -- NAS EP (Class B)}
  \includegraphics[width=.49\linewidth]{../paper/img/v2-nas-ep-raw.pdf}\hfill%
  \only<2->{\includegraphics[width=.49\linewidth]{../paper/img/v2-nas-ep-overhead.pdf}}
  ...
  \item<2-> Overhead with 16 MPI ranks: Singularity ($\approx$9\%),
    Docker ($\approx$8\%) \\
  \item<3-> Overhead increases with the number of MPI ranks
  \end{itemize}
}
...
\frame{\frametitle{Results -- Ondes3D Ligurian}
    \includegraphics[width=.49\linewidth]{../paper/img/v2-ondes3d-ligurian-raw.pdf}\hfill%
    \only<2->{\includegraphics[width=.49\linewidth]{../paper/img/v2-ondes3d-ligurian-overhead.pdf}}
...
\frame{\frametitle{Results -- Alpine Linux}
  \includegraphics[width=.49\linewidth]{alpine-nas-ondes3d-raw.png}\pause%
  \includegraphics[width=.49\linewidth]{alpine-nas-ondes3d-overhead.png}
}
