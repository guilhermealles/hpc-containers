...
\frame{\frametitle{conclusions}
    \begin{itemize}
        ...
        \item virtualization of the \textit{network} namespace has a negative impact on performance for MPI workloads
...
\frame{\frametitle{future work}
    \begin{itemize}
        ...
        \end{itemize}
        \item explore compatibility with other devices
        \begin{itemize}
            \item GPU
            \item InfiniBand
        \end{itemize}
