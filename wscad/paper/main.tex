...
In this work, our objective is to measure the performance impact of applying container technologies to execute HPC applications. We present an analysis covering both synthetic benchmarks and a real application comparing the usability of two major container systems - Docker and Singularity - using a traditional approach (with no virtualization) as a baseline. 
