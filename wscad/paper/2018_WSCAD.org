...
To ensure consistency between test cases against the Native OS, the
same Debian9 Linux distribution was used for the virtualized
...
by the MPI runtime. The multi-node container infrastructure for
