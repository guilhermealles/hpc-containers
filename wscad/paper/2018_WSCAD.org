...
small-message communications among MPI ranks. This is also valid for
the Ligurian earthquake (from 1887) \cite{aochi2011ligurian} with 300
timesteps, which has been used as workload for our tests. So, this
...
The experiment was also executed following a full factorial
