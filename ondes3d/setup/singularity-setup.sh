...
singularity exec $SINGULARITY_IMAGES_DIRECTORY/alpine-mpi-ondes3d.img ./ondes3d-mpi/compile-mpi.sh
...
singularity exec $SINGULARITY_IMAGES_DIRECTORY/alpine-omp-ondes3d.img ./ondes3d-omp/compile-omp.sh