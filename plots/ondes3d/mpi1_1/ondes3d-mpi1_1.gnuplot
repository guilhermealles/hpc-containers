...
set xtics  norangelimit 40
set xtics add  ("1" 1.00000, "4" 4.00000, "8" 8.00000, "16" 16.0000)
...
plot "docker.dat" using 1:2 with lines dashtype 2 lc rgb 'red' lw 1.5 title 'Docker',      "docker.dat" using 1:2:3:4 with errorbars lc rgb 'red' not,           "singularity.dat" using 1:2 with lines dashtype 4 lc rgb 'green' lw 1.5 title 'Singularity',      "singularity.dat" using 1:2:3:4 with errorbars lc rgb 'green' not,           "native.dat" using 1:2 with lines dashtype 1 lc rgb 'blue' lw 1.5 title 'Native',      "native.dat" using 1:2:3:4 with errorbars lc rgb 'blue' not
#    EOF
